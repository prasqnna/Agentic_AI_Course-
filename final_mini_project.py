...
# DO NOT create Account directly
# account=Account("987654321456",50000,"Savings",customer1)

user=Savings_account("987654321456",5000,"Savings",customer1,5)
user2=Savings_account("123456789012",20000,"Savings",customer1,5)
user1=Current_account("456789123456",50000,"Current",customer1,10000)
# ==============================
